...
\immediate\write18{texcount -template="{word} words in main body. Calculated with Texcount." \jobname.tex -out=\jobname.sum}
\usepackage{verbatim}
\usepackage{setspace}
\usepackage{booktabs}
\usepackage{lscape}
...
\maketitle
%TC:ignore
\abstract{How much does public sentiment affect social distancing? I investigate this question by exploiting a very large panel of tweets. Using geolocation data embedded in the tweets, I create an index of public sentiment towards COVID-19 at the county level, and use this index to estimate the extent to which local sentiment influences social distancing. Using a two-way fixed-effects design over two separate measures of public sentiment and two separate measures of social distancing, I find consistent evidence that an increase in negative or fearful sentiment about COVID-19 decreases the level of community mobility; completely negative sentiment corresponds to a 6.5\% reduction in proportion of devices leaving the home and 16,667 fewer minutes spent outside.}
\bigskip
\begin{center}
\textbf{Declaration} \\
...
\begin{tabular*}{0.9\textwidth}{l @{\extracolsep{\fill}} cc}
  ...
  \end{tabular*}
  \floatfoot{Trimmed specficiation, reporting proportion fearful tweets and NRC fear sentiment variable. With and without controls.}
\end{table}
%TC:endignore
...
Within Adjusted R$^2$ & 0.19660&0.16258&0.19588&0.16312\\
  ...
  \end{tabular}
  \floatfoot{Both NRC and VADER sentiment measures, county aggregated. Negative sentiment score bounded between 0 and 1, with 1 being fully negative. Deaths and cases cumulative by county. White heteroskedasticity-robust standard errors clustered at the county and week level.}
\end{table}
\end{singlespace}
%TC:endignore
...
\begin{table}
  ...
  (Intercept)&0.1986$^{***}$ & 0.1865$^{***}$ & 98,041.7$^{***}$ & 94,559.9$^{***}$ & 0.0674$^{***}$ & 0.0625$^{***}$ & 31,143.1$^{***}$ & 29,371.1$^{***}$\\
    ...
    Proportion fearful tweets &   & 0.0522$^{***}$ &    & -3,910.6 &    & 0.0484$^{***}$ &    & -3,461.6\\
    &   & (0.0053) &    & (4,217.1) &    & (0.0048) &    & (4,024.8)\\
  Negative sentiment score&0.0817$^{***}$ &    & -49,024.6$^{***}$ &    & 0.1652$^{***}$ &    & -34,204.6$^{**}$ &   \\
    &(0.0220) &    & (17,292.0) &    & (0.0199) &    & (16,540.4) &   \\
  National Stringency&0.0010$^{***}$ & 0.0010$^{***}$ & -1,280.5$^{***}$ & -1,256.8$^{***}$ & 0.0013$^{***}$ & 0.0012$^{***}$ & -1,164.5$^{***}$ & -1,148.5$^{***}$\\
    &($5.14\times 10^{-5}$) & ($5\times 10^{-5}$) & (40.37) & (39.41) & ($4.66\times 10^{-5}$) & ($4.54\times 10^{-5}$) & (38.64) & (37.73)\\
  State Stringency&0.0015$^{***}$ & 0.0015$^{***}$ & 112.9$^{***}$ & 107.4$^{***}$ & 0.0014$^{***}$ & 0.0014$^{***}$ & 45.61 & 42.55\\
...
\begin{table}
  ...
  \begin{tabular}{lcccccccc}
    ...
    Model:&(1) & (2) & (3) & (4) & (5) & (6) & (7) & (8)\\
    \midrule \emph{Variables}&   &   &   &   &   &   &   &  \\
    Negative sentiment score&0.0800$^{*}$ &    & -93,125.2$^{*}$ &    & 0.1033$^{**}$ &    & -8,463.4$^{**}$ &   \\
      &(0.0410) &    & (46,126.6) &    & (0.0403) &    & (2,386.6) &   \\
      Proportion fearful tweets&   & 0.0056 &    & -13,327.2$^{**}$ &    & 0.0067 &    & -1,011.9\\
      &   & (0.0063) &    & (5,441.5) &    & (0.0052) &    & (899.6)\\
      Nat Stringency&0.0029$^{***}$ & 0.0028$^{***}$ & -1,292.6$^{***}$ & -1,252.3$^{***}$ & 0.0034$^{***}$ & 0.0034$^{***}$ & -753.8$^{***}$ & -753.1$^{***}$\\
      &(0.0006) & (0.0007) & (194.3) & (205.7) & (0.0001) & (0.0001) & (14.68) & (14.29)\\
    State Stringency&$-2\times 10^{-5}$ & $-2.34\times 10^{-5}$ & -2.535 & 1.955 & 0.0005$^{**}$ & 0.0005$^{**}$ & -12.69 & -12.69\\
      &(0.0004) & (0.0005) & (176.5) & (178.8) & (0.0002) & (0.0002) & (27.80) & (27.82)\\
    Deaths&-0.0027 & -0.0027 & 3,578.2 & 3,611.5 & $-1.53\times 10^{-5}$ & $-1.55\times 10^{-5}$ & 11.14$^{*}$ & 11.16$^{*}$\\
