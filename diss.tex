...
Social media is increasingly important for news consumption: a survey by the Pew Research Foundation indicates that in 2019, 18\% of US adults identified social media as their primary source of political news \parencite{mitchellAmericansWhoMainly2020}. While a minority to Facebook and YouTube, Twitter is a significant platform: another Pew survey indicated that  22\% of US adults use the platform, with 42\% of these using it on a daily basis \parencite{perrinShareAdultsUsing2019}.
