...
\end{figure}
On visual inspection of figure \ref{popvsmobil}, a positive relationship does exist between the proportion staying at home and the county population (meaning that higher-population counties have \textit{decreased} mobility); however, it appears that this is primarily driven by the two large county outliers. These correspond to the highly dense Los Angeles County and Cooke County, Illinois\footnote{i.e., Chicago}. Discounting these highly dense outlier cities, we can tentatively say that mobility is largely independent of county population. As a consequence, an unbalanced panel could be accomodated. The Heckman correction procedure would be another option for obtaining unbiased parameter estimates \parencite{wooldridgeSelectionCorrectionsPanel1995}, as would weighting the samples by population; and the final option is to avoid aggregating the sentiment scores and run the empirical specification on the individual level. That is, the base unit is an individual tweet rather than the county/day. This yields a much larger panel of the individual observations.

Another concern is that the link between mobility and sentiment in the early pandemic could be largely driven by the states where the virus spread first: California, New York, and Washington. Dropping these states from the dataset, we observe that on the main specification three out of four models lose predictive power at the 10\% level, although these three models do have \(p\)-values of between 0.109 and 0.14; this may indicate that states where the virus spread first had both a higher negative sentiment and lower mobility, and that this `early' effect is confounder of the two variables. Investigating this further, we re-include the initial states and estimate a split-sample, where panels 
...
\section{Regression Tables}
  ...
  \begin{table}
    \caption{Main Specification: Drop CA, NY, WA}
    \begin{tabular}{lcccc}
      \tabularnewline\midrule\midrule
      ...
      Model:&(1) & (2) & (3) & (4)\\
      \midrule \emph{Variables}&   &   &   &  \\
      meanneg&0.0471 &    & -39,649.9 &   \\
        &(0.0350) &    & (26,418.7) &   \\
      NAT\_StringencyIndex&0.0028$^{***}$ & 0.0028$^{***}$ & -1,093.9$^{***}$ & -1,078.2$^{***}$\\
        &(0.0004) & (0.0004) & (214.2) & (213.8)\\
      STA\_StringencyIndex&0.0004 & 0.0004 & -175.4$^{*}$ & -174.3$^{*}$\\
        &(0.0002) & (0.0002) & (84.67) & (84.51)\\
      death&$-5.48\times 10^{-5}$ & $-5.48\times 10^{-5}$ & 172.9$^{**}$ & 172.9$^{**}$\\
        &($4\times 10^{-5}$) & ($4\times 10^{-5}$) & (78.23) & (78.07)\\
      confirmed&$9.05\times 10^{-6}$$^{**}$ & $9.05\times 10^{-6}$$^{**}$ & -19.34$^{***}$ & -19.34$^{***}$\\
        &($3.97\times 10^{-6}$) & ($3.97\times 10^{-6}$) & (5.545) & (5.534)\\
      meanfear&   & 0.0089 &    & -13,895.0$^{***}$\\
        &   & (0.0051) &    & (4,567.3)\\
      \midrule \emph{Fixed-effects}&   &   &   &  \\
      week & Yes & Yes & Yes & Yes\\
      FIPS & Yes & Yes & Yes & Yes\\
      ...
      Log-Likelihood & 27,279.4&27,277.9&-165,495.9&-165,491.1\\
      BIC & -49,240.9&-49,238.0&336,309.6&336,299.9\\
      RMSE & 0.03567&0.03567&26,807.6&26,798.4\\
      Size of the 'effective' sample & 14,248&14,248&14,248&14,248\\
      F-test & 143.99&143.95&74.628&74.695\\
      F-test (projected) & 470.51&469.84&903.78&906.26\\
...
\begin{table}
  \caption{Main Specification, first 6 weeks and second 6 weeks}\ref{tab:sixweeks}
  \begin{tabular}{lcccccccc}
    \tabularnewline\midrule\midrule
