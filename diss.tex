...
%\abstract{This is a writing sample to be submitted to Economics Masters programmes. The goals of the writing sample are to demonstrate proficiency in econometrics, an excellent knowledge of the current literature, etc. I demonstrate proficiency in econometrics by a good discussion and justification of the Bayesian method. That is, I justify using the Imperial College model rather than a Maximum Likelihood procedure, etc, and put the Bayesian approach into context.}
